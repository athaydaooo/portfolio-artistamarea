      ...
      <div className="flex flex-col w-screen h-[100h] items-center">
        <Gallery
          images={[
            ...
            { src: "/mareabee/9.jpg", ratio: AspectRatio.ClassicPortrait },
            { src: "/mareabee/10.jpg", ratio: AspectRatio.ClassicLandscape },
            { src: "/mareabee/11.jpg", ratio: AspectRatio.ClassicLandscape },
            { src: "/mareabee/12.jpg", ratio: AspectRatio.ClassicLandscape },
            ...
            { src: "/mareabee/19.jpg", ratio: AspectRatio.ClassicLandscape },
